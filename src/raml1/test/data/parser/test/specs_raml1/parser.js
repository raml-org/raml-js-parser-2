...
describe('Parser', function() {
  ...
  describe('URI Parameters', function() {
    ...
    it('should fail when declaring a URI parameter not on the baseUri', function(done) {
      ...
      raml.load(definition).should.be.rejectedWith(/Unused url parameter/).and.notify(done);
    });
    ...
    it('should fail when declaring a URI parameter not on the resource URI', function(done) {
      ...
      raml.load(definition).should.be.rejectedWith(/Unused url parameter \'a\'/).and.notify(done);
    });
    ...
    it('should fail when declaring a minLength validation as anything other than a number', function(done) {
      ...
      raml.load(definition).should.be.rejectedWith(/number is expected here/).and.notify(done);
    });
  ...
  describe('Resource Types', function () {
    ...
    it('should fail if names collide', function(done) {
      var definition = [
        '#%RAML 0.8',
        '---',
        'title: Test',
  ...
  describe('Parameter methods', function(){
    describe('- Unknown methods', function(){
      describe('- In resources', function(){
        ...
        it('should fail if calling an unknown method in a value in an unapplied type', function(done){
          var definition = [
            '#%RAML 0.8',
            '---',
            'title: Test',
      ...
      describe('- In traits', function(){
        ...
        it('should fail if calling an unknown method in a value in an unapplied trait', function(done){
          var definition = [
            '#%RAML 0.8',
            '---',
            'title: Test',
        ...
        it('should fail if calling an unknown method in a value in a trait without methods', function(done){
          var definition = [
            '#%RAML 0.8',
            '---',
            'title: Test',

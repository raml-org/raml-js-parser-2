...
export interface LibraryBase10 {
     ...
     * Deprecated - API definitions should use the \"types\" property, as the \"schemas\"
     * alias for that property name may be removed in a future RAML version.
     * The \"types\" property allows for XML and JSON schemas.
     */
    schemas?: { [key: string]: datamodel.TypeDeclaration }[]

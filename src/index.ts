 ...
 **/
export function load(ramlPath:string,options?:parserCore.Options1):Promise<Object>{
 ...
 **/
export function loadSync(ramlPath:string,options?:parserCore.Options1):Object{

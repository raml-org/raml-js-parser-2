 ...
 **/
export function parse(ramlPath:string,options?:parserCore.LoadOptions):Promise<hl.IHighLevelNode>{
 ...
 **/
export function parseSync(ramlPath:string,options?:parserCore.LoadOptions):hl.IHighLevelNode{
